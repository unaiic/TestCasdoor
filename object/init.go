...
func initBuiltInOrganization() {
	...
	organization = &Organization{
		...
		DisplayName:   "TREBE Language Technologies S.L.",
		WebsiteUrl:    "",
		Favicon:       "trebe_FAVICON.png",
		PhonePrefix:   "34",
		DefaultAvatar: "trebe_FAVICON.png",
		PasswordType:  "plain",
	}
...
func initBuiltInUser() {
	...
	user = &User{
		...
		Password:          "123",
		DisplayName:       "Admin",
		Avatar:            "trebe_FAVICON.png",
		Email:             "admin@example.com",
		Phone:             "12345678910",
		Address:           []string{},
		Affiliation:       "TREBE Language Technologies",
		Tag:               "staff",
		Score:             2000,
		Ranking:           1,
		IsAdmin:           true,
